...
export default function PetLogin() {
    ...
    const handleSendOtp = async () => {
        ...
        try {
            const response = await axios.post('https://www.doggy.adsdigitalmedia.com/api/v1/pet/pet-login', {
    ...
    const handleResendOtp = async () => {
        ...
        try {
            const response = await axios.post('https://www.doggy.adsdigitalmedia.com/api/v1/pet/pet-register-resendOtp', {
                ContactNumber: contactNumber
            });
            Toast.show({
                type: 'success',
