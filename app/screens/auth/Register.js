...
const Register = ({ navigation }) => {
  ...
  return (
    <View className="justify-center h-[80%]">
      ...
      <View className="flex-row mx-3 mt-5 flex-wrap justify-center">
        <Text className="text-sm tracking-wide font-medium text-gray-400">By entering your number, you agree to our </Text>
        <TouchableOpacity on>
          <Text className="text-blue-600 underline font-semibold">Terms & Conditions</Text>
        </TouchableOpacity>
        <Text className="text-sm tracking-wide font-medium text-gray-400"> and </Text>
        <TouchableOpacity>
          <Text className="text-blue-600 underline font-semibold">Privacy & Policy</Text>
        </TouchableOpacity>
      </View>
      <TouchableOpacity
