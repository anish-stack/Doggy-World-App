...
export default function VerificationStep() {
    ...
    const handleSendOtp = async () => {
        ...
        if (dataOnLocal) {
            ...
            try {
                const response = await axios.post('https://www.doggy.adsdigitalmedia.com/api/v1/pet/pet-register', data);
    ...
    const handleVerifyOtp = async () => {
        ...
        try {
            const response = await axios.post('https://www.doggy.adsdigitalmedia.com/api/v1/pet/pet-register-VerifyOtp', data);
            Toast.show({
                type: 'success',
    ...
    const handleResendOtp = async () => {
        ...
        try {
            const response = await axios.post('https://www.doggy.adsdigitalmedia.com/api/v1/pet/pet-register-resendOtp', data);
