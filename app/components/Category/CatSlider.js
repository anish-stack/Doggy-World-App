...
const CatSlider = () => {
    ...
    const fetchData = useCallback(async () => {
        try {
            const response = await axios.get('https://www.doggy.adsdigitalmedia.com/api/v1/Product/Get-All-category');
    ...
    return (
        <SafeAreaView>
            ...
            <View className="flex-row relative py-3 px-3 z-10 justify-between">
                ...
                <TouchableOpacity
                    onPress={openFilter}
                    className="flex-row items-center mb-2 bg-[#4FAD65] px-3  rounded-lg shadow-md"
                >
